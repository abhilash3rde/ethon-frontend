...
export const postProjectsAPI = (data) => {
    return axios.post(baseAPIURL + 'api/v1/project/create', data,
        token())
}

export const postProjectsPhotosAPI = (data) => {
    return axios.post(baseAPIURL + 'api/v1/project/add_photo', data,
        token())
}

export const filterProjectsAPI = (data) => {
    return axios.post(baseAPIURL + 'api/v1/projects', data,
        token())
}

export const postProjectDetailsAPI = (id) => {
    return axios.post(baseAPIURL + `api/v1/project/get_single_project`, id,
        token())
}

export const deleteProjectAPI = (id) => {
    return axios.post(baseAPIURL + `api/v1/project/delete`, id,
        token())
}

export const deleteProjectPhotoAPI = (data) => {
    return axios.post(baseAPIURL + `api/v1/project/delete_photo`, data,
        token())
}

export const EditProjectAPI = (data) => {
    return axios.post(baseAPIURL + `api/v1/project/update_project`, data,
        token())
}
