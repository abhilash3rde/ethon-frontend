...
export default function project_view() {
    ...
    const details_view = useSelector((state) => state.projectDetails.details.data.data)
                ...
                <div className="flex w-full items-center">
                    <div className="w-full grid my-8" >
                        ...
                        <div className="flex gap-2 asdasd justify-between items-center ">
                            <h1 className="text-[15px] font-[500]">{details_view?.project_name}</h1>
                            <span className="text-[10px] text-gray-400  ">
                                {details_view?.project_date && format(new Date(details_view?.project_date),
                                    'dd-MM-yyyy')} </span>
                        </div>
                        ...
                        <div className="grid grid-cols-1 w-full justify-items-center my-10">
                            ...
                            <div className='w-[70%] grid gap-6  text-center'>
                                <Button href={() => router.push('/projects/bids')} name={'Bid On Project'} />
                                <Button
                                    href={openPopup}
                                    bg={'bg-white '}
                                    color={' black'}
                        ...
                        <ProjectDecline datashow={showPopup ? "block" : "hidden"} onClicked={closePopup} />
                    </div>
                </div>
            </div>
