                ...
                <form   className="md:px-[50px] px-[10px] py-[30px] md:shadow-[0_0_8px_3px_#a0a0a11f] rounded-[7px]" >
                    ...
                    <div className='grid grid-cols-1 gap-[10px]'>
                        ...
                        <div className='grid grid-cols-1'>
                            <label className="font-medium text-[15px] my-[7px]">Username</label>
                            <input
                                name="username"
                                id="username"
                    ...
                    <div className='grid grid-cols-1 w-full justify-items-start'>
                        ...
                        <div className='grid grid-cols-1 w-[60%] mt-[2em] mb-[1em] text-center'>
                            <button onClick={Loginfarmik.handleSubmit} className="text-[#fff] font-medium bg-theme
                            py-[12px] rounded-[5px] px-[50px] hover:opacity-[0.85] shadow-lg shadow-black-500/40">Login</button>
                        </div>
