...
function ContractorsForm() {
   ...
   //    console.log('edit', editContractors)
      ...
      initialValues: {
         ...
         street_address:
            editContractors?.street_address && userEdit
               ...
               : '',
         services:
            editContractors?.services && userEdit
               ? editContractors?.services
               : '',
         city: editContractors?.city && userEdit ? editContractors?.city : '',
         state:
            editContractors?.state && userEdit ? editContractors?.state : '',
         ...
         // primary detalis
         primary_fname:
            editContractors?.primary_fname && userEdit
               ? editContractors?.primary_fname
               : '',
         primary_lname:
            editContractors?.primary_lname && userEdit
               ? editContractors?.primary_lname
               : '',
         primary_title:
            editContractors?.primary_title && userEdit
               ? editContractors?.primary_title
               : '',
         primary_phone_type:
            editContractors?.primary_phone_type && userEdit
               ? editContractors?.primary_phone_type
               : '',
         primary_phone:
                  ...
                  <div className="grid grid-cols-1 gap-2">
                     ...
                     <div className="grid gap-2">
                        ...
                        <Input
                           name={'primary_title'}
                           placeholder={'Title'}
                           value={ContractorFormik.values.primary_title}
                           formik={ContractorFormik}
                        />
