   ...
   return (
      <div className="register-page w-full flex items-center mt-16 mb-10">
         <div className="w-[90%] sm:w-[50%] mx-auto">
            ...
            <form
               method="POST"
               onSubmit={RegiFarmik.handleSubmit}
               className="sm:px-[50px] px-[10px] sm:py-[30px] sm:shadow-[0_0_8px_3px_#a0a0a11f] rounded-[7px] bg-[#fff]"
            >
               ...
               <div className="grid grid-cols-1 relative">
                  ...
                  <div className="relative">
                     ...
                     <span
                        ...
                        title={
                           showRepassword ? 'Show Password' : 'Hide Password'
                        }
                        className="font-mono cursor-pointer text-[1.5em] bg-white pl-2 
                                absolute right-3 bottom-3"
                     >
