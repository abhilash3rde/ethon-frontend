    ...
    return (
        <div className="forget-page w-full h-screen overflow-x-hidden flex items-center ">
            ...
            <div className="w-[90%] sm:w-[50%] mx-auto">
                ...
                <form method='POST' onSubmit={Newfarmik.handleSubmit} className="sm:px-[50px] px-[10px] py-[30px] sm:shadow-[0_0_8px_3px_#a0a0a11f] rounded-[7px] bg-[#fff]" >
                    ...
                    <div className='grid grid-cols-1 gap-[20px]'>
                        ...
                        <div className='grid grid-cols-1 relative'>
                            ...
                            {Newfarmik.errors.password &&
                                <span className='text-red-500'>{Newfarmik.errors.password}</span>
                            }
                        </div>
                        ...
                        <div className='grid grid-cols-1 relative'>
                            ...
                            <span
                                ...
                                title={showConformpass ? "Show Password" : "Hide Password"}
                                className="font-mono cursor-pointer text-[1.5em] bg-white pl-2 
                                    absolute right-3 bottom-3">
                                {showConformpass ? <BsEye /> : <BsEyeSlash />}</span>

                                </div>
                                {Newfarmik.errors.confirm &&
                                <span className='text-red-500'>{Newfarmik.errors.confirm}</span>
                            }
                        </div>
