               ...
               <div className="absolute w-[80%]  top-[30%] left-[10%] mx-auto bg-white rounded-[10px]">
                  <div className="text-black text-center px-4 py-8">
                     <p className="text-sm text-gray-500">
                        Are you sure you want to delete? This will permanently
                        delete all data for this photo.
                     </p>
                     ...
                     <div className="flex justify-center">
                        ...
                        >
                           <div
                              className=" py-2 w-[100%] mx-auto w-full flex justify-center text-red-600 
                                    rounded-[10px] "
                           >
                        ...
                        >
                           <div
                              className=" py-2 w-[100%] mx-auto w-full flex justify-center text-blue-600 
                                    rounded-[10px] "
                           >
