                  ...
                  <div className="absolute w-[80%] top-[22%] left-[10%] mx-auto bg-white rounded-[10px]">
                     <div className="text-black text-center px-4 pt-8">
                        <div className="grid grid-cols-2 gap-x-[10px] mb-4">
                           <label
                              className="w-full flex flex-col items-center  py-[5px] h-[35px] px-[10px] bg-white text-blue rounded-lg 
                        ...
                        <div className="mb-4 flex gap-2">
                           <label
                              className="w-[50px] justify-center flex flex-col items-center py-[5px] h-[50px] bg-white text-blue rounded-lg 
                     ...
                     <div className="flex justify-center mt-4">
                        ...
                        >
                           <button
                              type="button"
                              className=" py-4 w-[100%] mx-auto w-full flex justify-center text-black 
                                            rounded-[10px] "
                           >
                              Add
                           </button>
