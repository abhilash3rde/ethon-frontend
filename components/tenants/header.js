      ...
      return (
         <div className="logo">
            <div className="grid grid-cols-1 items-center">
               <h1 className="md:text-5xl font-bold cursor-pointer text-center text-[17px]">
                  {props.Subtitle}
               </h1>
            </div>
         </div>
      ...
      <div className="bg-white z-50">
         <div className="flex justify-between py-3 px-3 ">
            {props?.Maintitle ? (
               <div className="logo">
                  <div className="grid grid-cols-1 items-center">
                     {/* <h1 className="md:text-5xl font-bold cursor-pointer text-center text-4xl">
                        {props?.Maintitle}
                     </h1>*/}
               ...
               <div className="flex items-center gap-[10px]">
                  ...
                  <div className="logo">
                     <div className="grid grid-cols-1 items-center">
                        <h1 className="md:text-5xl font-bold cursor-pointer text-center text-xl">
                           {props?.title}
                        </h1>
                     </div>
                  </div>
         ...
         <div
            ...
            className={
               menu
                  ? 'w-[70%]  block fixed h-[100%] top-0 right-0 py-[10%] px-[5%] bg-[#f5f5f5] z-[999] shadow-[-11px_0px_20px_20px_#b3b3b330] overflow-y-scroll'
