...
function ProjectDecline(props) {
    ...
    return (
        <div className={props.datashow}>
            <div style={{ transition: '.5s', }} className='ProjectDecline h-screen bg-[#22222238] w-full fixed z-[100] top-0 left-0 overflow-hidden'>
                    ...
                    <div className="absolute w-[80%]  top-[30%] left-[10%] mx-auto bg-white rounded-[10px]">
                        <div className="text-black text-center px-4 py-8">
                            <p className="text-sm text-gray-500">
                                ...
                                This will let the property manager
                                know you are not interested in this
                                project.
                            </p>
